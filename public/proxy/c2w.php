...
$myfile = fopen("vars.txt", "r") or die("Unable to open vars.txt file!");
$apiKey = trim(fread($myfile, 500));
fclose($myfile);

$url = "https://api.what3words.com/v3/convert-to-3wa?coordinates=$lon%2C$lat&key=$apiKey";
